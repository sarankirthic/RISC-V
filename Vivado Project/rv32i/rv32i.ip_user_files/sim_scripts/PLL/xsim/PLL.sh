...
#
# Generated by Vivado on Thu May 27 11:04:56 +0530 2021
...
simulate()
{
  xsim PLL -key {Behavioral:sim_1:Functional:PLL} -tclbatch cmd.tcl -protoinst "protoinst_files/Instr_ROM.protoinst" -protoinst "protoinst_files/BRAM_32B_SDP.protoinst" -protoinst "protoinst_files/Data_RAM.protoinst" -protoinst "protoinst_files/PLL.protoinst" -log simulate.log
}
