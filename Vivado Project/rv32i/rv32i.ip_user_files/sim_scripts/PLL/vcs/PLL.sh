...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../riscv_j.gen/sources_1/bd/PLL/ipshared/d0f7" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../riscv_j.gen/sources_1/bd/PLL/ipshared/d0f7" \
    "$ref_dir/../../../bd/PLL/ip/PLL_clk_wiz_0_0/PLL_clk_wiz_0_0_clk_wiz.v" \
    "$ref_dir/../../../bd/PLL/ip/PLL_clk_wiz_0_0/PLL_clk_wiz_0_0.v" \
    "$ref_dir/../../../bd/PLL/sim/PLL.v" \
  2>&1 | tee -a vlogan.log
